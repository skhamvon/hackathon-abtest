...
- `abtest-docs/` → documentation publique (VitePress), déployée en général sur [GitHub Pages](https://skhamvon.github.io/abtest-docs/)
...
Après `git submodule update --init --recursive`, le dossier `abtest-docs/` contient les sources de la documentation (VitePress) ; le site publié est en général sur [GitHub Pages](https://skhamvon.github.io/abtest-docs/).
